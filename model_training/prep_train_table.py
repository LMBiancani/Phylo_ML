...
def main():
	...
	if len(sys.argv) > 1:
		...
		print("python3 prep_train_table.py [file with a list of paths] ([columns])")
		print("python3 prep_train_table.py train_list.txt")
		print("python3 prep_train_table.py train_list.txt 1 2 5")
