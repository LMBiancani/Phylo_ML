...
#cd ../simulations/empirical/mcgowen/1

#Rscript ../../../../simulation_scripts/generate_sim_properties.R
#cd ../../../../simulation_scripts
#pwd
Rscript run_SimPhy.R ../simulations/empirical/mcgowen/1/sptree.nex ../simulations/empirical/mcgowen/1/df.csv 3_run_simphy.sh ../simulations/empirical/mcgowen/1/gene_trees.tre ../simulations/empirical/mcgowen/1/	
